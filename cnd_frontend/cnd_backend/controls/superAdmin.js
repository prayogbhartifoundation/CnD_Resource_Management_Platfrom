...
sadmin_router.get("/api/superAdminLogout", (req, res) => {
  res.clearCookie("token");   // or whichever cookie you set
...
sadmin_router.post("/api/superAdminRegister", async (req, res) => {
  ...
  sadmin_router.get("/api/superAdminHome", verifyUser, (req, res) => {
